...
#' @param model a list that defines an `ramp.xde` model generated by `xde_setup_cohort()`
#' @param N an integer
#' @export
xde_scaling_eir = function(model, N=25){
  ...
  for(i in 1:N){
    ...
    xde_tmp <- ramp.xde::xde_stable_orbit(model)
...
#' @param model a list that defines an `ramp.xde` model generated by `xde_setup_human()`
...
xde_scaling_Z = function(model, N=25){
  ...
  model <- ramp.xde::make_indices(model)
  y0 = ramp.xde::get_inits(model)
...
#' @param model a list that defines an `ramp.xde` model (*e.g.*,  generated by `xde_setup()`)
#' @export
...
xde_scaling = function(model, N=25, F_eir=NULL){
  ...
  mod0 = ramp.xde::xde_setup_cohort("mod0", F_eir)
