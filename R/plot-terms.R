...
#'
#' @param pars a [list] that defines an `ramp.xds` model (*e.g.*,  generated by `ramp.xds::xde_setup()`)
...
#'
#' @param pars a [list] *e.g.*,  generated by `ramp.xds::xde_setup()` that defines a model in `ramp.xds`
#' @param clrs a [character] vector of colors
#' @param llty a [list]
#'
#' @export
