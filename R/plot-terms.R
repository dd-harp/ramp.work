...
#'
#' @param pars a [list] that defines an `ramp.xde` model (*e.g.*,  generated by `ramp.xde::xde_setup()`)
...
#'
#' @param pars a [list] *e.g.*,  generated by `ramp.xde::xde_setup()` that defines a model in `ramp.xde`
#' @param clrs a [character] vector of colors
#' @param llty a [list]
#'
#' @export
