...
vignette: "%\\VignetteIndexEntry{Evaluating Vector Control} %\\VignetteEngine{knitr::rmarkdown}
...
At some point, I'll have something more to say about the software design. Meanwhile, some functions that didn't get explained above:
